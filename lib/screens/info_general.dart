...
class _InformacionGeneralState extends State<InformacionGeneral> {
  ...
  void initState() {
    ...
    /// 🔹 Carga proyectos UNA sola vez
    Future.microtask(() {
      context.read<AppState>().cargarProyectos();
    });
  }
      ...
      child: Column(
        ...
        const SizedBox(height: 20),
          ...
          Container(
            ...
            child: Text(
              appState.proyectoSeleccionado?['region'] ?? '',
            ),
          ),
          ...
          Container(
            ...
            child: Text(
              appState.proyectoSeleccionado?['comuna'] ?? '',
            ),
          ),
          ...
          Container(
            ...
            child: Text(
              appState.proyectoSeleccionado?['etapa'] ?? '',
            ),
          ),
