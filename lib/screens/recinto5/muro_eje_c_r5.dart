...
class Muro_Eje_C_R5 extends StatefulWidget {//--------------------------------------------------cambiar al copiar pantalla
  const Muro_Eje_C_R5({super.key});//--------------------------------------------------cambiar al copiar pantalla

  @override
  State<Muro_Eje_C_R5> createState() => _Muro_Eje_C_R5();//--------------------------------------------------cambiar al copiar pantalla
}

class _Muro_Eje_C_R5 extends State<Muro_Eje_C_R5> {
  GlobalKey canvaskeyImg1_Muroc_R5 = GlobalKey(); //--------------------------------------------------cambiar al copiar pantalla
  GlobalKey canvaskeyImg2_Muroc_R5 = GlobalKey();//--------------------------------------------------cambiar al copiar pantalla

  List<Offset?> _pointsImg1_CR5 = [];//--------------------------------------------------cambiar al copiar pantalla
  List<Offset?> _pointsImg2_CR5 = [];//--------------------------------------------------cambiar al copiar pantalla

  @override
  Widget build(BuildContext context) {
    final appState = context.watch<AppState>();
    final hojaActual = appState.obtenerHojaMuro("Muro Eje C - Recinto 5");//--------------------------------------------------cambiar al copiar pantalla
        ...
        children: [
          Center(
              child: Row(
                  ...
                  children: [
                    Text(
                      "Muro Eje " + appState.r5_muroc_nombreController.text,  //---------------------------------------------------cambiar al  copiar pantalla
                    ...
                    IconButton(
                      onPressed:() async {
                        final nuevoNombre = await appState.EditarNombre(
                          context,
                          appState.r5_muroc_nombreController.text,            //----------------------------------------------------cambiar al copiar pantalla
                        );

                        if (nuevoNombre != null && nuevoNombre.isNotEmpty) {
                          appState.actualizarNombreMuro(35,nuevoNombre);//--------------------------------------------------cambiar al copiar pantalla
                        }
                      },
                ...
                onPressed: () => appState.obtenerImagenHojaMuro(
                  ...
                  onImagenSeleccionada: (img) {
                    setState(() {
                      ...
                      _pointsImg1_CR5.clear();//--------------------------------------------------cambiar al copiar pantalla
                    });
                  },
                ),
          ...
          if (hojaActual.imgpatol != null && hojaActual.imgpatolGuardada == null) ...[
            ...
            Center(
              child: RepaintBoundary(
                key: canvaskeyImg1_Muroc_R5,//--------------------------------------------------cambiar al copiar pantalla
                child: Container(
                  width: 900,
                  height: 800,
                        ...
                        onPanUpdate: (details) {
                          setState(() {
                            ...
                            if (localPosition.dx >= 0 &&
                              ...
                              _pointsImg1_CR5 = List.from(_pointsImg1_CR5)..add(localPosition);//--------------------------------------------------cambiar al copiar pantalla
                            }
                          });
                        },
                        onPanEnd: (_) => setState(() => _pointsImg1_CR5.add(null)),//--------------------------------------------------cambiar al copiar pantalla
                        child: CustomPaint(
                          painter: DibujoPainter(_pointsImg1_CR5),//--------------------------------------------------cambiar al copiar pantalla
                        ),
                      );
                    },
                  ),
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () async {
                  await appState.guardarDibujoHojaMuro(
                    canvasKey: canvaskeyImg1_Muroc_R5,//--------------------------------------------------cambiar al copiar pantalla
                    hoja: hojaActual,
                    imgnum: 1,
                    onGuardado: (file) {
                      setState(() {
                ...
                onPressed: () => appState.obtenerImagenHojaMuro(
                  ...
                  onImagenSeleccionada: (img) {
                    setState(() {
                      ...
                      _pointsImg2_CR5.clear();//--------------------------------------------------cambiar al copiar pantalla
                    });
                  },
                ),
                icon: Icon(Icons.camera_alt),
          ...
          if (hojaActual.imgelev != null && hojaActual.imgelevGuardada == null) ...[
            ...
            Center(
              child: RepaintBoundary(
                key: canvaskeyImg2_Muroc_R5,//--------------------------------------------------cambiar al copiar pantalla
                child: Container(
                  width: 900,
                  height: 800,
                  decoration: BoxDecoration(
                        ...
                        onPanUpdate: (details) {
                          setState(() {
                            ...
                            if (localPosition.dx >= 0 &&
                                ...
                                localPosition.dy >= 0 &&
                                localPosition.dy <= constraints.maxHeight) {
                              _pointsImg2_CR5 = List.from(_pointsImg2_CR5)..add(localPosition);//--------------------------------------------------cambiar al copiar pantalla
                            }
                          });
                        },
                        onPanEnd: (_) => setState(() => _pointsImg2_CR5.add(null)),//--------------------------------------------------cambiar al copiar pantalla
                        child: CustomPaint(
                          painter: DibujoPainter(_pointsImg2_CR5),//--------------------------------------------------cambiar al copiar pantalla
                        ),
                      );
                    },
                  ),
            ...
            Center(
              child: ElevatedButton.icon(
                ...
                onPressed: () async {
                  await appState.guardarDibujoHojaMuro(
                    canvasKey: canvaskeyImg2_Muroc_R5,//--------------------------------------------------cambiar al copiar pantalla
                    hoja: hojaActual,
                    imgnum: 2,
                    onGuardado: (file) {
                      setState(() {
