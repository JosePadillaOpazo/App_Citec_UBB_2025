...
class Muro_Principal_R5 extends StatefulWidget {
  const Muro_Principal_R5({super.key});

  @override
  State<Muro_Principal_R5> createState() => _Muro_Principal_R5();
}

class _Muro_Principal_R5 extends State<Muro_Principal_R5> {
  GlobalKey canvaskeyImg2_Murop_R5 = GlobalKey();

  List<Offset?> _pointsImg2_PR5 = [];


  @override
  Widget build(BuildContext context) {
    final appState = context.watch<AppState>();
    final hojaActual = appState.obtenerHojaMuroPrincipal("Muro Eje Principal - Recinto 5");
        ...
        children: [
          Center(
            child: Row(
              ...
              children: [
                Text(
                  "Muro Principal Eje " + appState.r5_murop_nombreController.text,
                ...
                IconButton(
                  onPressed:() async {
                    final nuevoNombre = await appState.EditarNombre(
                      context,
                      appState.r5_murop_nombreController.text,
                    );
                    if (nuevoNombre != null && nuevoNombre.isNotEmpty) {
                      appState.actualizarNombreMuro(33,nuevoNombre);
                    }
                  },
          ...
          TextFormField(
            controller: appState.r5_murop_nombreController,
            enabled: false,
                        ...
                        onPanUpdate: (details) {
                          setState(() {
                            ...
                            if (localPosition.dx >= 0 &&
                              ...
                              _pointsImg2_PR5 = List.from(_pointsImg2_PR5)..add(localPosition);
                            }
                          });
                        },
                        onPanEnd: (_) => setState(() => _pointsImg2_PR5.add(null)),
                        child: CustomPaint(
                          painter: DibujoPainter(_pointsImg2_PR5),
                        ),
                      );
                    },
                  ),
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () async {
                  await appState.guardarDibujoHojaPrincipal(
                    canvasKey: canvaskeyImg2_Murop_R5,
                    hoja: hojaActual,
                    imgnum: 2,
                    onGuardado: (file) {
                      setState(() {
