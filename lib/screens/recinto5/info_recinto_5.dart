...
class Info_Recinto_5 extends StatefulWidget {
  const Info_Recinto_5({super.key});

  @override
  State<Info_Recinto_5> createState() => _Info_Recinto_5();
}

class _Info_Recinto_5 extends State<Info_Recinto_5> {
  GlobalKey canvaskeyImg1_Murop_R5 = GlobalKey();

  List<Offset?> _pointsImg1_PR5 = [];
        ...
        children: [
          Center(
            child: Row(
              ...
              children: [
                Text(
                  "Información de " + appState.recinto5_nombreController.text,
                        ...
                        onPanUpdate: (details) {
                          setState(() {
                            ...
                            if (localPosition.dx >= 0 &&
                              ...
                              _pointsImg1_PR5 = List.from(_pointsImg1_PR5)..add(localPosition);
                            }
                          });
                        },
                        onPanEnd: (_) => setState(() => _pointsImg1_PR5.add(null)),
                        child: CustomPaint(
                          painter: DibujoPainter(_pointsImg1_PR5),
                        ),
                      );
                    },
                  ),
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () async {
                  await appState.guardarDibujoHojaPrincipal(
                    canvasKey: canvaskeyImg1_Murop_R5,
                    hoja: hojaActual,
                    imgnum: 1,
                    onGuardado: (file) {
                      setState(() {
