...
class Info_Recinto_4 extends StatefulWidget {
  const Info_Recinto_4({super.key});

  @override
  State<Info_Recinto_4> createState() => _Info_Recinto_4();
}

class _Info_Recinto_4 extends State<Info_Recinto_4> {
  GlobalKey canvaskeyImg1_Murop_R4 = GlobalKey();

  List<Offset?> _pointsImg1_PR4 = [];
                        ...
                        onPanUpdate: (details) {
                          setState(() {
                            ...
                            if (localPosition.dx >= 0 &&
                              ...
                              _pointsImg1_PR4 = List.from(_pointsImg1_PR4)..add(localPosition);
                            }
                          });
                        },
                        onPanEnd: (_) => setState(() => _pointsImg1_PR4.add(null)),
                        child: CustomPaint(
                          painter: DibujoPainter(_pointsImg1_PR4),
                        ),
                      );
                    },
                  ),
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () async {
                  await appState.guardarDibujoHojaPrincipal(
                    canvasKey: canvaskeyImg1_Murop_R4,
                    hoja: hojaActual,
                    imgnum: 1,
                    onGuardado: (file) {
                      setState(() {
