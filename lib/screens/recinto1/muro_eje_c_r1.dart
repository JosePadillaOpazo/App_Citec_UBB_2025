...
class Muro_Eje_C_R1 extends StatefulWidget {
  const Muro_Eje_C_R1({super.key});

  @override
  State<Muro_Eje_C_R1> createState() => _Muro_Eje_C_R1State();
}

class _Muro_Eje_C_R1State extends State<Muro_Eje_C_R1> {
  GlobalKey canvaskeyImg1_Muroc_R1 = GlobalKey();//---------------------------------------------------------------------> Editar al copiar la hoja
  GlobalKey canvaskeyImg2_Muroc_R1 = GlobalKey();

  List<Offset?> _pointsImg1_CR1 = [];//---------------------------------------------------------------------> Editar al copiar la hoja
  List<Offset?> _pointsImg2_CR1 = [];


  @override
  Widget build(BuildContext context) {
    final appState = context.watch<AppState>();
    final hojaActual = appState.obtenerHojaMuro("Muro Eje C - Recinto 1"); //---------------------------------------------------------------------> Editar al copiar la hoja
        ...
        children: [
          Center(
            child: Row(
              ...
              children: [
                Text(
                  appState.r1_muroc_nombreController.text,//----------------------------------------------------------------------------------> Editar al copiar la hoja
                ...
                IconButton(
                  onPressed:() async {
                    ...
                    if (nuevoNombre != null && nuevoNombre.isNotEmpty) {
                      appState.actualizarNombreMuro(3,nuevoNombre);//--------------------------------------------------------------------------> Editar al copiar la hoja
                    }
                  },
                        ...
                        onPanUpdate: (details) {
                          setState(() {
                            ...
                            if (localPosition.dx >= 0 &&
                              ...
                              _pointsImg1_CR1 = List.from(_pointsImg1_CR1)..add(localPosition);
                            }
                          });
                        },
                        onPanEnd: (_) => setState(() => _pointsImg1_CR1.add(null)),
                        child: CustomPaint(
                          painter: DibujoPainter(_pointsImg1_CR1),
                        ),
                      );
                    },
                  ),
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () async {
                  await appState.guardarDibujoHojaMuro(
                    canvasKey: canvaskeyImg1_Muroc_R1,
                    hoja: hojaActual,
                    imgnum: 1,
                    onGuardado: (file) {
                      setState(() {
          ...
          if (hojaActual.imgelev != null && hojaActual.imgelevGuardada == null) ...[
                        ...
                        onPanUpdate: (details) {
                          setState(() {
                            ...
                            if (localPosition.dx >= 0 &&
                                ...
                                localPosition.dy >= 0 &&
                                localPosition.dy <= constraints.maxHeight) {
                              _pointsImg2_CR1 = List.from(_pointsImg2_CR1)..add(localPosition);
                            }
                          });
                        },
                        onPanEnd: (_) => setState(() => _pointsImg2_CR1.add(null)),
                        child: CustomPaint(
                          painter: DibujoPainter(_pointsImg2_CR1),
                        ),
                      );
                    },
                  ),
            ...
            Center(
              child: ElevatedButton.icon(
                ...
                onPressed: () async {
                  await appState.guardarDibujoHojaMuro(
                    canvasKey: canvaskeyImg2_Muroc_R1,
                    hoja: hojaActual,
                    imgnum: 2,
                    onGuardado: (file) {
                      setState(() {
