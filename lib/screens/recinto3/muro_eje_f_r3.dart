...
class Muro_Eje_F_R3 extends StatefulWidget {//--------------------------------------------------cambiar al copiar pantalla
  const Muro_Eje_F_R3({super.key});//--------------------------------------------------cambiar al copiar pantalla

  @override
  State<Muro_Eje_F_R3> createState() => _Muro_Eje_F_R3();//--------------------------------------------------cambiar al copiar pantalla
}

class _Muro_Eje_F_R3 extends State<Muro_Eje_F_R3> {
  GlobalKey canvaskeyImg1_Murof_R3 = GlobalKey(); //--------------------------------------------------cambiar al copiar pantalla
  GlobalKey canvaskeyImg2_Murof_R3 = GlobalKey();//--------------------------------------------------cambiar al copiar pantalla

  List<Offset?> _pointsImg1_FR3 = [];//--------------------------------------------------cambiar al copiar pantalla
  List<Offset?> _pointsImg2_FR3 = [];//--------------------------------------------------cambiar al copiar pantalla

  @override
  Widget build(BuildContext context) {
    final appState = context.watch<AppState>();
    final hojaActual = appState.obtenerHojaMuro("Muro Eje F - Recinto 3");//--------------------------------------------------cambiar al copiar pantalla
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
                    ...
                    IconButton(
                      onPressed:() async {
                        final nuevoNombre = await appState.EditarNombre(
                          context,
                          appState.r3_murof_nombreController.text,            //----------------------------------------------------cambiar al copiar pantalla
                        );

                        if (nuevoNombre != null && nuevoNombre.isNotEmpty) {
                          appState.actualizarNombreMuro(22,nuevoNombre);//--------------------------------------------------cambiar al copiar pantalla
                        }
                      },
          ...
          TextFormField(
            controller: appState.r3_murof_nombreController,//--------------------------------------------------cambiar al copiar pantalla
            enabled: false,
                ...
                onPressed: () => appState.obtenerImagenHojaMuro(
                  ...
                  onImagenSeleccionada: (img) {
                    setState(() {
                      ...
                      _pointsImg1_FR3.clear();//--------------------------------------------------cambiar al copiar pantalla
                    });
                  },
                ),
          ...
          if (hojaActual.imgpatol != null && hojaActual.imgpatolGuardada == null) ...[
            ...
            Center(
              child: RepaintBoundary(
                key: canvaskeyImg1_Murof_R3,//--------------------------------------------------cambiar al copiar pantalla
                child: Container(
                  width: 900,
                  height: 800,
                        ...
                        onPanUpdate: (details) {
                          setState(() {
                            ...
                            if (localPosition.dx >= 0 &&
                              ...
                              _pointsImg1_FR3 = List.from(_pointsImg1_FR3)..add(localPosition);//--------------------------------------------------cambiar al copiar pantalla
                            }
                          });
                        },
                        onPanEnd: (_) => setState(() => _pointsImg1_FR3.add(null)),//--------------------------------------------------cambiar al copiar pantalla
                        child: CustomPaint(
                          painter: DibujoPainter(_pointsImg1_FR3),//--------------------------------------------------cambiar al copiar pantalla
                        ),
                      );
                    },
                  ),
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () async {
                  await appState.guardarDibujoHojaMuro(
                    canvasKey: canvaskeyImg1_Murof_R3,//--------------------------------------------------cambiar al copiar pantalla
                    hoja: hojaActual,
                    imgnum: 1,
                    onGuardado: (file) {
                      setState(() {
                ...
                onPressed: () => appState.obtenerImagenHojaMuro(
                  ...
                  onImagenSeleccionada: (img) {
                    setState(() {
                      ...
                      _pointsImg2_FR3.clear();//--------------------------------------------------cambiar al copiar pantalla
                    });
                  },
                ),
                icon: Icon(Icons.camera_alt),
          ...
          if (hojaActual.imgelev != null && hojaActual.imgelevGuardada == null) ...[
            ...
            Center(
              child: RepaintBoundary(
                key: canvaskeyImg2_Murof_R3,//--------------------------------------------------cambiar al copiar pantalla
                child: Container(
                  width: 900,
                  height: 800,
                  decoration: BoxDecoration(
                        ...
                        onPanUpdate: (details) {
                          setState(() {
                            ...
                            if (localPosition.dx >= 0 &&
                                ...
                                localPosition.dy >= 0 &&
                                localPosition.dy <= constraints.maxHeight) {
                              _pointsImg2_FR3 = List.from(_pointsImg2_FR3)..add(localPosition);//--------------------------------------------------cambiar al copiar pantalla
                            }
                          });
                        },
                        onPanEnd: (_) => setState(() => _pointsImg2_FR3.add(null)),//--------------------------------------------------cambiar al copiar pantalla
                        child: CustomPaint(
                          painter: DibujoPainter(_pointsImg2_FR3),//--------------------------------------------------cambiar al copiar pantalla
                        ),
                      );
                    },
                  ),
            ...
            Center(
              child: ElevatedButton.icon(
                ...
                onPressed: () async {
                  await appState.guardarDibujoHojaMuro(
                    canvasKey: canvaskeyImg2_Murof_R3,//--------------------------------------------------cambiar al copiar pantalla
                    hoja: hojaActual,
                    imgnum: 2,
                    onGuardado: (file) {
                      setState(() {
