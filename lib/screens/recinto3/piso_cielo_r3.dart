...
class Piso_Cielo_R3 extends StatefulWidget {
  const Piso_Cielo_R3({super.key});

  @override
  State<Piso_Cielo_R3> createState() => _Piso_Cielo_R3();
}

class _Piso_Cielo_R3 extends State<Piso_Cielo_R3> {
  GlobalKey canvaskeyPiso_R3 = GlobalKey();
  GlobalKey canvaskeyCielo_R3 = GlobalKey();
  ...
  Widget build(BuildContext context) {
    ...
    final hojaActual = appState.obtenerHojaPisoCielo("Piso Cielo - Recinto 3"); //---------------------------------------------------------------------> Editar al copiar la hoja
        ...
        children: [
          ...
          if (hojaActual.imgpiso != null && hojaActual.imgPisoGuardada == null) ...[
            ...
            Center(
              child: RepaintBoundary(
                key: canvaskeyPiso_R3, //---------------------------------------------------------------------------> Editar al copiar la hoja
                child: Container(
                  width: 900,
                  height: 800,
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () async {
                  await appState.guardarDibujoHojaPisoCielo(
                    canvasKey: canvaskeyPiso_R3, //---------------------------------------------------------------------> Editar al copiar la hoja
                    hoja: hojaActual,
                    imgnum: 1,
                    onGuardado: (file) {
                      setState(() {
         ...
         // --------------------------------------------------------------------
          ...
          if (hojaActual.imgcielo != null && hojaActual.imgCieloGuardada == null) ...[
            ...
            Center(
              child: RepaintBoundary(
                key: canvaskeyCielo_R3, //---------------------------------------------------------------------------> Editar al copiar la hoja
                child: Container(
                  width: 900,
                  height: 800,
                  decoration: BoxDecoration(
            ...
            Center(
              child: ElevatedButton.icon(
                ...
                onPressed: () async {
                  await appState.guardarDibujoHojaPisoCielo(
                    canvasKey: canvaskeyCielo_R3, //---------------------------------------------------------------------> Editar al copiar la hoja
                    hoja: hojaActual,
                    imgnum: 2,
                    onGuardado: (file) {
                      setState(() {
