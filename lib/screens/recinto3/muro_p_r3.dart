...
class Muro_Principal_R3 extends StatefulWidget {
  const Muro_Principal_R3({super.key});

  @override
  State<Muro_Principal_R3> createState() => _Muro_Principal_R3();
}

class _Muro_Principal_R3 extends State<Muro_Principal_R3> {
  GlobalKey canvaskeyImg2_Murop_R3 = GlobalKey();

  List<Offset?> _pointsImg2_PR3 = [];


  @override
  Widget build(BuildContext context) {
    final appState = context.watch<AppState>();
    final hojaActual = appState.obtenerHojaMuro("Muro Eje A - Recinto 3");
        ...
        children: [
          Center(
            child: Row(
              ...
              children: [
                Text(
                  "Muro Eje " + appState.r3_murop_nombreController.text,
                ...
                IconButton(
                  onPressed:() async {
                    final nuevoNombre = await appState.EditarNombre(
                      context,
                      appState.r3_murop_nombreController.text,
                    );

                    if (nuevoNombre != null && nuevoNombre.isNotEmpty) {
                      appState.actualizarNombreMuro(17,nuevoNombre);
                    }
                  },
          ...
          TextFormField(
            controller: appState.r3_murop_nombreController,
            enabled: false,
                        ...
                        onPanUpdate: (details) {
                          setState(() {
                            ...
                            if (localPosition.dx >= 0 &&
                              ...
                              _pointsImg2_PR3 = List.from(_pointsImg2_PR3)..add(localPosition);
                            }
                          });
                        },
                        onPanEnd: (_) => setState(() => _pointsImg2_PR3.add(null)),
                        child: CustomPaint(
                          painter: DibujoPainter(_pointsImg2_PR3),
                        ),
                      );
                    },
                  ),
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () async {
                  await appState.guardarDibujoHojaMuro(
                    canvasKey: canvaskeyImg2_Murop_R3,
                    hoja: hojaActual,
                    imgnum: 2,
                    onGuardado: (file) {
                      setState(() {
