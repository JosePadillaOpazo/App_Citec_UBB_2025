...
class Info_Recinto_3 extends StatefulWidget {
  const Info_Recinto_3({super.key});

  @override
  State<Info_Recinto_3> createState() => _Info_Recinto_3();
}

class _Info_Recinto_3 extends State<Info_Recinto_3> {
  GlobalKey canvaskeyImg1_Murop_R3 = GlobalKey();

  List<Offset?> _pointsImg1_PR3 = [];
        ...
        children: [
          Center(
            child: Row(
              ...
              children: [
                Text(
                  "Información de " + appState.recinto3_nombreController.text,
                        ...
                        onPanUpdate: (details) {
                          setState(() {
                            ...
                            if (localPosition.dx >= 0 &&
                              ...
                              _pointsImg1_PR3 = List.from(_pointsImg1_PR3)..add(localPosition);
                            }
                          });
                        },
                        onPanEnd: (_) => setState(() => _pointsImg1_PR3.add(null)),
                        child: CustomPaint(
                          painter: DibujoPainter(_pointsImg1_PR3),
                        ),
                      );
                    },
                  ),
