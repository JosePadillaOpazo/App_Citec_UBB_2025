...
class Piso_Cielo_R2 extends StatefulWidget {
  const Piso_Cielo_R2({super.key});

  @override
  State<Piso_Cielo_R2> createState() => _Piso_Cielo_R2State();
}

class _Piso_Cielo_R2State extends State<Piso_Cielo_R2> {
  GlobalKey canvaskeyPiso_R2 = GlobalKey();
  GlobalKey canvaskeyCielo_R2 = GlobalKey();
  ...
  Widget build(BuildContext context) {
    ...
    final hojaActual = appState.obtenerHojaPisoCielo("Piso Cielo - Recinto 2"); //---------------------------------------------------------------------> Editar al copiar la hoja
        ...
        children: [
          ...
          if (hojaActual.imgpiso != null && hojaActual.imgPisoGuardada == null) ...[
            ...
            Center(
              child: RepaintBoundary(
                key: canvaskeyPiso_R2, //---------------------------------------------------------------------------> Editar al copiar la hoja
                child: Container(
                  width: 900,
                  height: 800,
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () async {
                  await appState.guardarDibujoHojaPisoCielo(
                    canvasKey: canvaskeyPiso_R2, //---------------------------------------------------------------------> Editar al copiar la hoja
                    hoja: hojaActual,
                    imgnum: 1,
                    onGuardado: (file) {
                      setState(() {
         ...
         // --------------------------------------------------------------------
          ...
          if (hojaActual.imgcielo != null && hojaActual.imgCieloGuardada == null) ...[
            ...
            Center(
              child: RepaintBoundary(
                key: canvaskeyCielo_R2, //---------------------------------------------------------------------------> Editar al copiar la hoja
                child: Container(
                  width: 900,
                  height: 800,
                  decoration: BoxDecoration(
            ...
            Center(
              child: ElevatedButton.icon(
                ...
                onPressed: () async {
                  await appState.guardarDibujoHojaPisoCielo(
                    canvasKey: canvaskeyCielo_R2, //---------------------------------------------------------------------> Editar al copiar la hoja
                    hoja: hojaActual,
                    imgnum: 2,
                    onGuardado: (file) {
                      setState(() {
